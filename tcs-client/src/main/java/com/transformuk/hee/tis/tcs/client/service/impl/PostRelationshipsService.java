...
public class PostRelationshipsService<DTO> {
  ...
  private static final Map<Class, ParameterizedTypeReference> classToParamTypeRefMap = Maps
      .newHashMap();
  ...
  public List<DTO> bulkUpdatePostRelationships(List<DTO> posts, String endpointUrl,
      Class<DTO> dtoClass) {
    final ParameterizedTypeReference parameterizedTypeReference = getClassToParamTypeRefMap()
        .get(dtoClass);

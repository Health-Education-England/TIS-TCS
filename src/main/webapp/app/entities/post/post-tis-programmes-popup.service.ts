...
@Injectable()
export class PostTisProgrammesPopupService {
	...
	open(component: Component, id?: number | any): NgbModalRef {
		...
		if (id) {
			...
			return this.postModalRef(component, new PostTisProgrammes());
		}
	}

	postModalRef(component: Component, post: PostTisProgrammes): NgbModalRef {

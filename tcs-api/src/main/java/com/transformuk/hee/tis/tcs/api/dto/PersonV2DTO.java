 ...
 *
 * The issues was around the ger person endpoint where it provides too much information. This DTO will be used in a new
 * endpoint so have as little impact on other services on the origin get person endpoint as possible
 */

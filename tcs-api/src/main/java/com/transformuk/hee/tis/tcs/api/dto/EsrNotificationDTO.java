...
public class EsrNotificationDTO implements Serializable {
  ...
  public boolean isPostVacantAtNextRotation() {
  ...
  public String toString() {
    return "EsrNotificationDTO{" +
        "id=" + id +
        ", notificationTitleCode='" + notificationTitleCode + '\'' +
        ", deaneryBody='" + deaneryBody + '\'' +
        ", deaneryPostNumber='" + deaneryPostNumber + '\'' +
        ", managingDeaneryBodyCode='" + managingDeaneryBodyCode + '\'' +
        ", occupationCode='" + occupationCode + '\'' +
        ", hostLeadEmployerStatus='" + hostLeadEmployerStatus + '\'' +
        ", newTrainingPositionLocation='" + newTrainingPositionLocation + '\'' +
        ", currentTraineeLastName='" + currentTraineeLastName + '\'' +
        ", currentTraineeFirstName='" + currentTraineeFirstName + '\'' +
        ", currentTraineeGmcNumber='" + currentTraineeGmcNumber + '\'' +
        ", currentTraineeProjectedEndDate='" + currentTraineeProjectedEndDate + '\'' +
        ", currentTraineeVpdForNextPlacement='" + currentTraineeVpdForNextPlacement + '\'' +
        ", nextAppointmentTraineeLastName='" + nextAppointmentTraineeLastName + '\'' +
        ", nextAppointmentTraineeFirstName='" + nextAppointmentTraineeFirstName + '\'' +
        ", nextAppointmentTraineeGmcNumber='" + nextAppointmentTraineeGmcNumber + '\'' +
        ", nextAppointmentCurrentPlacementVpd='" + nextAppointmentCurrentPlacementVpd + '\'' +
        ", nextAppointmentProjectedStartDate='" + nextAppointmentProjectedStartDate + '\'' +
        ", nextAppointmentTraineeEmailAddress='" + nextAppointmentTraineeEmailAddress + '\'' +
        ", nextAppointmentTraineeGrade='" + nextAppointmentTraineeGrade + '\'' +
        ", withdrawnTraineeLastName='" + withdrawnTraineeLastName + '\'' +
        ", withdrawnTraineeFirstName='" + withdrawnTraineeFirstName + '\'' +
        ", withdrawnTraineeGmcNumber='" + withdrawnTraineeGmcNumber + '\'' +
        ", withdrawalReason='" + withdrawalReason + '\'' +
        ", replacementTraineeLastName='" + replacementTraineeLastName + '\'' +
        ", replacementTraineeFirstName='" + replacementTraineeFirstName + '\'' +
        ", replacementTraineeGmcNumber='" + replacementTraineeGmcNumber + '\'' +
        ", replacementTraineeCurrentPlacementVpd='" + replacementTraineeCurrentPlacementVpd + '\'' +
        ", replacementTraineeProjectedHireDate='" + replacementTraineeProjectedHireDate + '\'' +
        ", changeOfProjectedHireDate='" + changeOfProjectedHireDate + '\'' +
        ", changeOfProjectedEndDate='" + changeOfProjectedEndDate + '\'' +
        ", postSpeciality='" + postSpeciality + '\'' +
        ", workingHourIndicator=" + workingHourIndicator +
        ", postVacantAtNextRotation=" + postVacantAtNextRotation +
        ", medicalRotationPostDeleteIndicator='" + medicalRotationPostDeleteIndicator + '\'' +
        '}';
  }
}

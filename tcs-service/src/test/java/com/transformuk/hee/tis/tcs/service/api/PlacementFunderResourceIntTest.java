...
public class PlacementFunderResourceIntTest {
  ...
  public void setup() {
    ...
    PlacementFunderResource placementFunderResource = new PlacementFunderResource(
        placementFunderService);
  ...
  public void updatePlacementFunder() throws Exception {
    ...
    PlacementFunder updatedPlacementFunder = placementFunderRepository
        .findById(placementFunder.getId()).orElse(null);

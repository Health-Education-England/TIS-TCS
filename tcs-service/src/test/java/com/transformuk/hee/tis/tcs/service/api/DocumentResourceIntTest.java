...
public class DocumentResourceIntTest {
  ...
  private final ObjectMapper jacksonMapper = createObjectMapper(new LocalDateTimeDeserializer(),
  ...
  @Test
  public void bulkUpdateDocuments_shouldReturnHTTP200_WhenMetadataIsUpdatedWith2Tags()
      throws Exception {
    ...
    ScriptUtils.executeSqlScript(connection, new ByteArrayResource(
        getSql(getSql(SQL_INSERT_DOCUMENT, documentId, PERSON_BASE_ID)).getBytes()));

    updateMetadataWith2Tags(documentId);
  }

  @Test
  public void bulkUpdateDocuments_shouldReturnHTTP200_WhenMetadataIsUpdatedWithNewTag()
      throws Exception {
    final long documentId = DOCUMENT_BASE_ID + 30;

    final Connection connection = jdbcTemplate.getDataSource().getConnection();
    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_DOCUMENT, documentId, PERSON_BASE_ID).getBytes()));
    ...
    final DocumentDTO updatedDocumentWith3Tags = jacksonMapper
        .readValue(response.getResponse().getContentAsString(), DocumentDTO.class);

    assertThat(updatedDocumentWith3Tags.getTags()).hasSize(3)
        .containsAll(updatedDocumentWith2Tags.getTags());
  }

  @Test
  public void bulkUpdateDocuments_shouldReturnHTTP200_WhenMetadataIsUpdatedWithNewAndDeletedTag()
      throws Exception {
    ...
    final DocumentDTO updatedDocumentWith1Tag = jacksonMapper
        .readValue(response.getResponse().getContentAsString(), DocumentDTO.class);

    assertThat(updatedDocumentWith1Tag.getTags()).hasSize(2)
        .containsAll(updatedDocumentWith2Tags.getTags());
  }
  ...
  public void getAllDocuments_shouldReturnHTTP200_WhenSearchQueryMatchesName() throws Exception {
    ...
    final List<DocumentDTO> documents = assertPaginationDocumentsExist(
        response.getResponse().getContentAsString(), 1);
  ...
  @Test
  public void getAllDocuments_shouldReturnHTTP200_WhenSearchQueryMatchesFileName()
      throws Exception {
  ...
  @Test
  public void getAllDocuments_shouldReturnHTTP200_WhenSearchQueryMatchesFileExtension()
      throws Exception {
    ...
    final List<DocumentDTO> documents = assertPaginationDocumentsExist(
        response.getResponse().getContentAsString(), 2);
  ...
  @Test
  public void getAllDocuments_shouldReturnHTTP200_WhenSearchQueryMatchesContentType()
      throws Exception {
  ...
  public void getAllDocuments_shouldReturnHTTP200_WhenRequestedFistPage() throws Exception {
    ...
    final PageImplTest<DocumentDTO> documents = jacksonMapper
        .readValue(response.getResponse().getContentAsString(),
            new TypeReference<PageImplTest<DocumentDTO>>() {
            });
  ...
  public void getAllTags_shouldReturnHTTP200_WhenQueryStartsWithOrderAsc() throws Exception {
    ...
    final List<TagDTO> responseBody = jacksonMapper
        .readValue(response.getResponse().getContentAsString(),
            new TypeReference<ArrayList<TagDTO>>() {
            });
  ...
  private DocumentDTO updateMetadataWith2Tags(final long documentId) throws Exception {
    ...
    final DocumentDTO updatedDocument = jacksonMapper
        .readValue(response.getResponse().getContentAsString(), DocumentDTO.class);
  ...
  private void initDB() throws SQLException {
    ...
    final Connection connection = jdbcTemplate.getDataSource().getConnection();
    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_PERSON, PERSON_BASE_ID).getBytes()));

    long tagId = TAG_BASE_ID;

    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_TAG, tagId++, "abcdef").getBytes()));
    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_TAG, tagId++, "abcxyz").getBytes()));
    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_TAG, tagId++, "xabcxyz").getBytes()));
    ScriptUtils.executeSqlScript(connection,
        new ByteArrayResource(getSql(SQL_INSERT_TAG, tagId++, "ghijkl").getBytes()));

    insertBaseData(connection);
  }

  private ObjectMapper createObjectMapper(final JsonDeserializer deserializer,
  ...
  private void insertBaseData(final Connection connection) {
    String query =
        "INSERT INTO `Document` (`id`, `addedDate`, `amendedDate`, `inactiveDate`, `uploadedBy`, `title`, `fileName`, `fileExtension`, `contentType`, `size`, `personId`, `status`, `version`)\n"
            +
            "VALUES" +
            "(" + (DOCUMENT_BASE_ID + 1001)
            + ", '2018-03-27 14:14:20', '2018-03-27 14:14:20.367', NULL, 'User 1', 'Document AAAAA', 'document1.jpg', 'jpg', 'image/jpeg', 56353, "
            + PERSON_BASE_ID + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1002)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 1', 'Document BBBBB', 'document2.png', 'png', 'image/png', 12123, "
            + PERSON_BASE_ID + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1003)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 1', 'Document CCCCC', 'document3.jpg', 'jpg', 'image/jpeg', 12982, "
            + PERSON_BASE_ID + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1004)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 2', 'Document DDDDD', 'document4.jpg', 'jpg', 'image/jpeg', 23423, "
            + (PERSON_BASE_ID + 1) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1005)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1006)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1007)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1008)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1009)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1010)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 3', 'Document XXXXX', 'documentX.jpg', 'jpg', 'image/jpeg', 98123, "
            + (PERSON_BASE_ID + 2) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1011)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 4', 'Document To Delete 1', 'documentToDelete1.jpg', 'jpg', 'image/jpeg', 23423, "
            + (PERSON_BASE_ID + 3) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1012)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 4', 'Document To Delete 2', 'documentToDelete2.jpg', 'jpg', 'image/jpeg', 45654, "
            + (PERSON_BASE_ID + 3) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1013)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 4', 'Document To Delete 3', 'documentToDelete3.jpg', 'jpg', 'image/jpeg', 78976, "
            + (PERSON_BASE_ID + 3) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1014)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 5', 'Document With Tags 1', 'DocumentWithTags1.jpg', 'jpg', 'image/jpeg', 8768, "
            + (PERSON_BASE_ID + 4) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1015)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 5', 'Document With Tags 2', 'DocumentWithTags2.jpg', 'jpg', 'image/jpeg', 8769, "
            + (PERSON_BASE_ID + 4) + ", 'CURRENT', NULL)," +
            "(" + (DOCUMENT_BASE_ID + 1016)
            + ", '2018-03-27 15:10:59', '2018-03-27 15:14:36.624', NULL, 'User 5', 'Document With Tags 3', 'DocumentWithTags3.jpg', 'jpg', 'image/jpeg', 8760, "
            + (PERSON_BASE_ID + 4) + ", 'CURRENT', NULL);";
  ...
  private void assertPaginationDocumentsDoNotExist(final String json) throws IOException {
    final PageImplTest<DocumentDTO> documents = jacksonMapper
        .readValue(json, new TypeReference<PageImplTest<DocumentDTO>>() {
        });
  ...
  private List<DocumentDTO> assertPaginationDocumentsExist(final String json,
      final int expectedElements) throws IOException {
    final PageImplTest<DocumentDTO> documents = jacksonMapper
        .readValue(json, new TypeReference<PageImplTest<DocumentDTO>>() {
        });
  ...
  /**
   * The intention of this class is to ease the asserts in tests and was created because Jackson
   * {@link ObjectMapper} cannot instantiate {@link org.springframework.data.domain.PageImpl}.
   */

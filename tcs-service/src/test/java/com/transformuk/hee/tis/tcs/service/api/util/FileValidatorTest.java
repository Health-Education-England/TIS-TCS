...
public class FileValidatorTest {
  ...
  private static final byte[] PDF_BYTES  = {(byte) 0x25, (byte) 0x50, (byte) 0x44, (byte) 0x46,
                                             (byte) 0x2D, (byte) 0x31, (byte) 0x2E, (byte) 0x34}; // %PDF-1.4
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenDocumentIsNull() {
    assertThat(FileValidator.isValidFileType(null)).isFalse();
  }

  @Test
  public void isValidFileType_shouldReturnFalse_whenExtensionIsDisallowedTxt() {
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenExtensionIsDisallowedExe() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenExtensionIsDisallowedJpg() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenFileHasNoExtension() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenFilenameEndsWithTrailingDot() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenFileTooSmallForMagicBytesCheck() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenSpoofedPdfHasMzHeader() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenSpoofedDocHasPdfHeader() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenSpoofedXlsHasZipHeader() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenSpoofedDocxHasOle2Header() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "spoofed.docx",
  ...
  @Test
  public void isValidFileType_shouldReturnFalse_whenSpoofedXlsxHasOle2Header() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "spoofed.xlsx",
  ...
  @Test
  public void isValidFileType_shouldReturnTrue_whenValidPdf() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldReturnTrue_whenValidDoc() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "document.doc", "application/msword", OLE2_BYTES);
    assertThat(FileValidator.isValidFileType(file)).isTrue();
  }

  @Test
  public void isValidFileType_shouldReturnTrue_whenValidXls() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "spreadsheet.xls", "application/vnd.ms-excel", OLE2_BYTES);
    assertThat(FileValidator.isValidFileType(file)).isTrue();
  }

  @Test
  public void isValidFileType_shouldReturnTrue_whenValidDocx() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "document.docx",
        "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
        ZIP_BYTES);
  ...
  @Test
  public void isValidFileType_shouldReturnTrue_whenValidXlsx() {
    final MockMultipartFile file = new MockMultipartFile(
  ...
  @Test
  public void isValidFileType_shouldBeCaseInsensitive_forExtension() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "document.PDF", "application/pdf", PDF_BYTES);
    assertThat(FileValidator.isValidFileType(file)).isTrue();
  }
  ...
  @Test
  public void isValidFileType_shouldResolveCorrectly_whenFilenameHasMultipleDots() {
    final MockMultipartFile file = new MockMultipartFile(
        "file", "document.pdf", "application/pdf", PDF_BYTES);
    assertThat(FileValidator.isValidFileType(file)).isTrue();
  }

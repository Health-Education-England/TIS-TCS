...
begin
  ...
  INSERT INTO `PersonView` (`id`, `intrepidId`, `surname`, `forenames`, `gmcNumber`, `gdcNumber`, `publicHealthNumber`, `programmeId`, `programmeName`, `programmeNumber`, `trainingNumber`, `gradeAbbreviation`, `siteCode`, `placementType`, `role`, `status`, `currentOwner`, `currentOwnerRule`)
  select p.id,
         p.intrepidId,
         cd.surname,
         cd.forenames,

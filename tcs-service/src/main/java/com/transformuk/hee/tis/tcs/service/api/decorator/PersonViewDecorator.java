...
public class PersonViewDecorator {
  ...
  protected CompletableFuture<Void> decorateGradesOnPerson(Set<Long> gradeIds,
      List<PersonViewDTO> personViewDTOs) {
  ...
  protected CompletableFuture<Void> decorateSitesOnPerson(Set<Long> siteIds,
      List<PersonViewDTO> personViewDTOs) {

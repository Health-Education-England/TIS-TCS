...
public interface TariffFundingTypeFieldsMapper {
  ...
  TariffFundingTypeFieldsDTO tariffFundingTypeFieldsToTariffFundingTypeFieldsDTO(
      TariffFundingTypeFields tariffFundingTypeFields);

  List<TariffFundingTypeFieldsDTO> tariffFundingTypeFieldsToTariffFundingTypeFieldsDTOs(
      List<TariffFundingTypeFields> tariffFundingTypeFields);

  TariffFundingTypeFields tariffFundingTypeFieldsDTOToTariffFundingTypeFields(
      TariffFundingTypeFieldsDTO tariffFundingTypeFieldsDTO);

  List<TariffFundingTypeFields> tariffFundingTypeFieldsDTOsToTariffFundingTypeFields(
      List<TariffFundingTypeFieldsDTO> tariffFundingTypeFieldsDTOs);

...
public class TariffRateServiceImpl implements TariffRateService {
  ...
  public TariffRateServiceImpl(TariffRateRepository tariffRateRepository,
  ...
  public Page<TariffRateDTO> findAll(Pageable pageable) {
    ...
    return tariffRatesPage
        .map(tariffRate -> tariffRateMapper.tariffRateToTariffRateDTO(tariffRate));
  }

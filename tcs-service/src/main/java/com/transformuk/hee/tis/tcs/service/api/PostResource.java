...
public class PostResource {
  ...
  @GetMapping("/test2")
  public PostDTO blah2(@RequestParam String newId) {
    Post post = new Post();
...
//    Post fullPostDetailsByPostId = postRepository.findFullPostDetailsByPostId(saved.getId());

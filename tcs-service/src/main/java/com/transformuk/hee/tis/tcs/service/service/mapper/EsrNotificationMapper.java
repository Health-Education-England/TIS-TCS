...
public interface EsrNotificationMapper {
  ...
  List<EsrNotificationDTO> esrNotificationsToPlacementDetailDTOs(
      List<EsrNotification> placementDetails);

  EsrNotification esrNotificationDTOToEsrNotification(EsrNotificationDTO placementDetailsDTO);

  List<EsrNotification> esrNotificationDTOsToEsrNotifications(
      List<EsrNotificationDTO> placementDetailsDTOs);

...
public class PostFundingResource {
  ...
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<List<PostFundingDTO>> bulkCreatePostFundings(@Valid @RequestBody List<PostFundingDTO> postFundingDTOS) {
  ...
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<List<PostFundingDTO>> bulkUpdatePostFundings(@Valid @RequestBody List<PostFundingDTO> postFundingDTOS) {

...
public class TariffFundingTypeFieldsResource {
  ...
  public TariffFundingTypeFieldsResource(
      TariffFundingTypeFieldsService tariffFundingTypeFieldsService) {
   ...
   * tariffFundingTypeFieldsDTO, or with status 400 (Bad Request) if the tariffFundingTypeFields has
   * already an ID
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  @PostMapping("/tariff-funding-type-fields")
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<TariffFundingTypeFieldsDTO> createTariffFundingTypeFields(
      @RequestBody TariffFundingTypeFieldsDTO tariffFundingTypeFieldsDTO)
    ...
    if (tariffFundingTypeFieldsDTO.getId() != null) {
      return ResponseEntity.badRequest().headers(HeaderUtil
          .createFailureAlert(ENTITY_NAME, "idexists",
              "A new tariffFundingTypeFields cannot already have an ID")).body(null);
    }
    TariffFundingTypeFieldsDTO result = tariffFundingTypeFieldsService
        .save(tariffFundingTypeFieldsDTO);
   ...
   * tariffFundingTypeFieldsDTO, or with status 400 (Bad Request) if the tariffFundingTypeFieldsDTO
   * is not valid, or with status 500 (Internal Server Error) if the tariffFundingTypeFieldsDTO
   * couldnt be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  @PutMapping("/tariff-funding-type-fields")
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<TariffFundingTypeFieldsDTO> updateTariffFundingTypeFields(
      @RequestBody TariffFundingTypeFieldsDTO tariffFundingTypeFieldsDTO)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(HeaderUtil
            .createEntityUpdateAlert(ENTITY_NAME, tariffFundingTypeFieldsDTO.getId().toString()))
        .body(result);
  }
  ...
  public ResponseEntity<List<TariffFundingTypeFieldsDTO>> getAllTariffFundingTypeFields(
      Pageable pageable) {
    ...
    HttpHeaders headers = PaginationUtil
        .generatePaginationHttpHeaders(page, "/api/tariff-funding-type-fields");
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the tariffFundingTypeFieldsDTO,
   * or with status 404 (Not Found)
   */
  @GetMapping("/tariff-funding-type-fields/{id}")
  @PreAuthorize("hasAuthority('tcs:view:entities')")
  public ResponseEntity<TariffFundingTypeFieldsDTO> getTariffFundingTypeFields(
      @PathVariable Long id) {
    log.debug("REST request to get TariffFundingTypeFields : {}", id);
    TariffFundingTypeFieldsDTO tariffFundingTypeFieldsDTO = tariffFundingTypeFieldsService
        .findOne(id);
   ...
   * tariffFundingTypeFieldsDTOS, or with status 400 (Bad Request) if the Tariff Funding Type Fields
   * has already an ID
   */
  @PostMapping("/bulk-tariff-funding-type-fields")
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<List<TariffFundingTypeFieldsDTO>> bulkCreateTariffFundingTypeFields(
      @Valid @RequestBody List<TariffFundingTypeFieldsDTO> tariffFundingTypeFieldsDTOS) {
      ...
      if (!Collections.isEmpty(entityIds)) {
        return ResponseEntity.badRequest().headers(HeaderUtil
            .createFailureAlert(StringUtils.join(entityIds, ","), "ids.exist",
                "A new Tariff Funding Type Fields cannot already have an ID")).body(null);
      }
    }
    List<TariffFundingTypeFieldsDTO> result = tariffFundingTypeFieldsService
        .save(tariffFundingTypeFieldsDTOS);
    List<Long> ids = result.stream().map(TariffFundingTypeFieldsDTO::getId)
        .collect(Collectors.toList());
    return ResponseEntity.ok()
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated
   * tariffFundingTypeFieldsDTOS, or with status 400 (Bad Request) if the
   * tariffFundingTypeFieldsDTOS is not valid, or with status 500 (Internal Server Error) if the
   * tariffFundingTypeFieldsDTOS couldnt be updated
   */
  @PutMapping("/bulk-tariff-funding-type-fields")
  @PreAuthorize("hasAuthority('tcs:add:modify:entities')")
  public ResponseEntity<List<TariffFundingTypeFieldsDTO>> bulkUpdateTariffFundingTypeFields(
      @Valid @RequestBody List<TariffFundingTypeFieldsDTO> tariffFundingTypeFieldsDTOS) {
    log.debug("REST request to bulk update Tariff Funding Type Fields : {}",
        tariffFundingTypeFieldsDTOS);
    if (Collections.isEmpty(tariffFundingTypeFieldsDTOS)) {
      ...
      List<TariffFundingTypeFieldsDTO> entitiesWithNoId = tariffFundingTypeFieldsDTOS.stream()
    ...
    List<TariffFundingTypeFieldsDTO> results = tariffFundingTypeFieldsService
        .save(tariffFundingTypeFieldsDTOS);
    List<Long> ids = results.stream().map(TariffFundingTypeFieldsDTO::getId)
        .collect(Collectors.toList());
    return ResponseEntity.ok()

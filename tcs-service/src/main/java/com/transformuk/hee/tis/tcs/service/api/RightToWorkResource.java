...
public class RightToWorkResource {
  ...
  @Timed
  public ResponseEntity<RightToWorkDTO> createRightToWork(@RequestBody RightToWorkDTO rightToWorkDTO) throws URISyntaxException {
  ...
  @Timed
  public ResponseEntity<RightToWorkDTO> updateRightToWork(@RequestBody RightToWorkDTO rightToWorkDTO) throws URISyntaxException {

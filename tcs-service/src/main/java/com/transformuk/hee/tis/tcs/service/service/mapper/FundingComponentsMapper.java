...
public interface FundingComponentsMapper {
  ...
  List<FundingComponentsDTO> fundingComponentsToFundingComponentsDTOs(
      List<FundingComponents> fundingComponents);

  FundingComponents fundingComponentsDTOToFundingComponents(
      FundingComponentsDTO fundingComponentsDTO);

  List<FundingComponents> fundingComponentsDTOsToFundingComponents(
      List<FundingComponentsDTO> fundingComponentsDTOs);
}

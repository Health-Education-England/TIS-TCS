package com.transformuk.hee.tis.aop.auditing;
...
public class AuditingAspect {
	 ...
	 */
	@Pointcut("execution(* com.transformuk.hee.tis.web.rest.*.create*(..))")
	 ...
	 */
	@Pointcut("execution(* com.transformuk.hee.tis.web.rest.*.update*(..))")
	 ...
	 */
	@Pointcut("execution(* com.transformuk.hee.tis.web.rest.*.delete*(..))")
